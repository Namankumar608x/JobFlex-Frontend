      ...
      <div className="flex-1 bg-zinc-50 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-[380px]">
          ...
          {/* <div className="anim-3">
            <button className="w-full flex items-center justify-center gap-2.5 bg-white border border-zinc-300 hover:border-zinc-900 text-zinc-700 text-sm font-medium py-2.5 rounded-lg transition-all hover:shadow-sm">
